...
def redcap_epic_grouping(csv_path):
...
csv_path = filename
if 'DATA_LABELS' not in csv_path:
    msgbox = tk.messagebox.showerror(title='Wrong File Format', message='Export CSV from REDCap with Data Labels.', icon='warning')
else:
    redcap_epic_grouping(csv_path)
